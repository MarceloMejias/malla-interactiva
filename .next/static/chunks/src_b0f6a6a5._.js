...
function useCalculator(subjects, careerKey) {
    ...
    const getStorageKey = (career)=>"".concat(STORAGE_KEY_PREFIX, "-").concat(career);
...
function CurriculumGrid() {
    ...
    const [showCareerSelector, setShowCareerSelector] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
                ...
                "CurriculumGrid.useEffect.loadCareers": async ()=>{
                    try {
                        ...
                        if (lastSelectedCareer) {
                            ...
                            const careerExists = allCareers.some({
                                "CurriculumGrid.useEffect.loadCareers.careerExists": (career)=>career.Link === lastSelectedCareer
                            }["CurriculumGrid.useEffect.loadCareers.careerExists"]);
                            if (careerExists) {
    ...
    const { subjectStates, updateSubjectState, resetCalculator, calculateCredits, isLoaded } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCalculator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCalculator"])(subjects, selectedCareer);
    ...
    const getMaxSemesters = ()=>{
        ...
        const semesterNumbers = subjects.map((subject)=>subject.semester).filter((semester)=>semester !== undefined && semester.startsWith('s')).map((semester)=>parseInt(semester.replace('s', ''))).filter((num)=>!isNaN(num));
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: "flex items-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 hover:scale-105 ".concat(darkMode ? 'bg-gray-700 hover:bg-gray-600 text-gray-200 border border-gray-600' : 'bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 shadow-sm'),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        maxSemesters > 4 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "text-xs text-center mb-2 ".concat(darkMode ? 'text-gray-400' : 'text-gray-600', " md:hidden"),
                                            children: "← Desliza para ver todos los semestres →"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/CurriculumGrid.tsx",
                                            lineNumber: 290,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            style: {
                                                minWidth: maxSemesters <= 8 ? '100%' : "".concat(maxSemesters * 200, "px")
                                            },
                                            children: Array.from({
                                                length: maxSemesters
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex flex-col rounded-2xl shadow-md border flex-shrink-0 ".concat(darkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-100 border-gray-200'),
                                                    style: {
                                                        width: maxSemesters <= 4 ? 'calc((100% - 0.75rem) / 4)' : maxSemesters <= 6 ? 'calc((100% - 1.25rem) / 6)' : maxSemesters <= 8 ? 'calc((100% - 1.75rem) / 8)' : '200px',
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: "Actualizado: Agosto 2025"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/CurriculumGrid.tsx",
                                        lineNumber: 386,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                        ...
                                        className: "flex items-center gap-2 transition-colors duration-300 ".concat(darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-gray-900'),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$fortawesome$2f$react$2d$fontawesome$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FontAwesomeIcon"], {
...
_s(CurriculumGrid, "CKjpAKO4OZ7LnKM1ozV+VQCw5uI=", false, function() {
    return [
